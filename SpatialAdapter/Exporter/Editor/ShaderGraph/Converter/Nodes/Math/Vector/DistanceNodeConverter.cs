...
{
    internal class DistanceNodeConverter : NodeConverterBase<DistanceNode>
    {
        ...
        public override void Convert(AbstractMaterialNode shaderGraphNode, MaterialXGraphData graph, StagingEdges stagingEdges)
        {
            ...
            MaterialXGraphUtil.AddNaryOperatorNode(MaterialXNodeType.Distance, shaderGraphNode, graph, stagingEdges, "Distance", portMap);
        }
    }
}